...
//
//	- github.com/williamsharkey/compilePub/internal/goobj/read.go (used by cmd/addr2line, cmd/nm, cmd/objdump, cmd/pprof)
//	- github.com/williamsharkey/compilePub/internal/obj/objfile.go (used by cmd/asm and cmd/compile)

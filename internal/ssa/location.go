...
type Register struct {
	...
	objNum int16 // register number from github.com/williamsharkey/compilePub/internal/obj/$ARCH
	name   string
}
...
// ObjNum returns the register number from github.com/williamsharkey/compilePub/internal/obj/$ARCH that

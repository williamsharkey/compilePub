...
import (
	"github.com/williamsharkey/compilePub/internal/types"
	"github.com/williamsharkey/compilePub/internal/src"
	"fmt"
	"math"
	"sort"
	"strings"
...
// Reg returns the register assigned to v, in github.com/williamsharkey/compilePub/internal/obj/$ARCH numbering.
...
// Reg0 returns the register assigned to the first output of v, in github.com/williamsharkey/compilePub/internal/obj/$ARCH numbering.
...
// Reg1 returns the register assigned to the second output of v, in github.com/williamsharkey/compilePub/internal/obj/$ARCH numbering.
